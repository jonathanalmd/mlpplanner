...
def p_strips_initial_state_1(p):
    '''strips_initial_state : INITIAL CONDITIONS COLON LPAREN AND strips_lista_predicados RPAREN'''
...
def p_strips_lista_predicados_2(p):
    '''strips_lista_predicados : strips_predicado strips_lista_predicados'''
    errorhandler.linestrips = plex.lexer.lineno

def p_strips_predicado_1(p):
    '''strips_predicado : LPAREN ID strips_lista_ids RPAREN'''
    objStrips.appendPredName(p[2])
    objStrips.appendListIds()

def p_strips_predicado_2(p):
    '''strips_predicado : LPAREN NOT LPAREN ID strips_lista_ids RPAREN RPAREN'''
    objStrips.appendPredName("!"+p[4])
    objStrips.appendListIds()

def p_strips_predicado_3(p):
    '''strips_predicado : LPAREN ID RPAREN'''
    objStrips.appendPredName(p[2])
    objStrips.appendListIds()

def p_strips_predicado_4(p):
    '''strips_predicado : LPAREN NOT LPAREN ID RPAREN RPAREN'''
    objStrips.appendPredName("!"+p[4])
    objStrips.appendListIds()

def p_strips_predicado_5(p):
    '''strips_predicado : '''
    # objStrips.appendPredName("")
    objStrips.appendListIds()
...
def p_strips_goal_state_1(p):
    '''strips_goal_state : GOAL COLON LPAREN AND strips_lista_predicados RPAREN'''
...
def p_strips_action_1(p):
    '''strips_action : ID COLON PRECONDITION strips_lista_predicados COLON EFFECT strips_lista_predicados'''
    print(p[1])
    objStrips.dealWithAction(p[1])

def p_strips_action_2(p):
    '''strips_action : ID COLON PRECONDITION LPAREN AND strips_lista_predicados RPAREN COLON EFFECT LPAREN AND strips_lista_predicados RPAREN'''
    print(p[1])
    objStrips.dealWithAction(p[1])

def p_strips_action_3(p):
    '''strips_action : ID COLON PRECONDITION strips_lista_predicados COLON EFFECT LPAREN AND strips_lista_predicados RPAREN'''
    print(p[1])
    objStrips.dealWithAction(p[1])

def p_strips_action_4(p):
    '''strips_action : ID COLON PRECONDITION null_rule COLON EFFECT LPAREN AND strips_lista_predicados RPAREN'''
    print(p[1])
    objStrips.dealWithAction(p[1])
